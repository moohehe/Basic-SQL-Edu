	...
	*/
	...
	$("select#langop").change(function(){
		if($('#langop option:selected').val()==1){
			$('#header_text').html('Anyone can easily learn the basics of SQL sysntax<br> by playing through a simple and intuitive mini-game.');
			...
			$('#story2').html('\"You must clear 20 trials if you wish to go back to the world where you belong to.\" <br>Let\'s beat the total of 20 sql quizzes to get back home safe!');
